...
@Directive({
  ...
  host: {
    "[attr.tabindex]": "0",
    "class": "cursor-pointer px-2 py-1 rounded-lg border transition-all duration-200 inline-flex justify-center items-center gap-x-2.5 focus:outline-2 focus:outline-neutral-0 focus:outline-offset-2",
